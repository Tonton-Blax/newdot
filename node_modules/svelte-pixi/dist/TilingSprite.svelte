...
// TilingSprite props
export let clampMargin = undefined;
export let tileTransform = undefined;
export let uvMatrix = undefined;
export let uvRespectAnchor = undefined;
export let tilePosition = undefined;
/** @type {PIXI.TilingSprite} PIXI.TilingSprite instance to render */
export let instance = new TilingSprite(texture, width, height);
